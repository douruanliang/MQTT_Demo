...
class NotificationHelper {
    ...
    static void showNoti(ActionListener.Action action, boolean state, String message) {
        ...
        Intent intent = new Intent(BaseApp.getApplication(), TestActivity.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(BaseApp.getApplication(), REQUEST_CODE_TESTACTIVITY, intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationManager manager = (NotificationManager) BaseApp.getApplication()
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            notificationBuilder = new NotificationCompat.Builder(BaseApp.getApplication(),CHANNEL_DEFAULT);
        }else {
            notificationBuilder = new NotificationCompat.Builder(BaseApp.getApplication(), (Notification) null);
        }
