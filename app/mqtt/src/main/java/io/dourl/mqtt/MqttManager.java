...
public class MqttManager {
    ...
    public void init() {
        ...
        mqttAndroidClient = new MqttAndroidClient(BaseApp.getApplication(),
    ...
    public IMqttToken connect(boolean cleanSession) {
        ...
        try {
            return mqttAndroidClient.connect(conOpt, null,
                    new ActionListener(BaseApp.getApplication(), ActionListener.Action.CONNECT, null));
...
//    }
    ...
    public Future<?> destroy() {
        return JobManager.getInstance().addJob(new MqttDestroyJob());
    }
